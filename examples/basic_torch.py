"""
wget https://github.com/thewh1teagle/rmvpe-onnx/releases/download/model-files-v1.0/rmvpe.safetensors
wget https://github.com/thewh1teagle/phonikud-chatterbox/releases/download/asset-files-v1/female1.wav
uv run --extra torch examples/basic_torch.py
"""
...
def main() -> None:
    model_path = Path("rmvpe.safetensors")
